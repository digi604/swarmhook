...
========================================================================
  ...
  📚 DOCUMENTATION:
  ────────────────
  • Quick Start:   https://github.com/swarmmarket/swarmhook#readme
  • Security:      https://github.com/swarmmarket/swarmhook/blob/main/SECURITY.md
  • Architecture:  https://github.com/swarmmarket/swarmhook/blob/main/ARCHITECTURE.md
  • Deploy Guide:  https://github.com/swarmmarket/swarmhook/blob/main/DEPLOYMENT.md
...
app.get('/skill.json', (c) => {
  const metadata = {
    ...
    support: 'https://github.com/swarmmarket/swarmhook/issues'
  }
